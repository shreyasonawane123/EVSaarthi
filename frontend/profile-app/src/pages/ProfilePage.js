            ...
            <div className="p-4 md:p-6 lg:p-8 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <p className="text-[11px] text-gray-400 font-medium ml-1 leading-relaxed">
                    Check your electricity bill for ₹/unit rate. Default ₹7 works for
                    most Indian cities. Used to calculate your EV charging cost vs petrol savings.
                  </p>
                </div>
              </div>
              ...
              {errorInfo && (
                <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3 text-red-600">
                  <ErrorIcon />
                  <span className="text-sm font-bold">{errorInfo}</span>
                </div>
              )}
              {savedInfo && (
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3 text-green-700">
                  <CheckCircleIcon />
                  <span className="text-sm font-bold">Personal info saved successfully!</span>
                </div>
              )}
