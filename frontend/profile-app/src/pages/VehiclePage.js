...
const VehiclePage = () => {
  ...
  const handleSaveVehicle = async () => {
    ...
    try {
      ...
      setErrorVehicle(
        err.response?.data?.error || "Failed to save vehicle details. Please try again."
      );
    } finally {
        ...
        >
          ...
          <div className="flex lg:block items-center gap-3 lg:gap-4 mb-0 lg:mb-0 lg:text-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="hidden lg:inline-flex bg-[#FFFBEB] border border-[#FDE68A] rounded-full py-1.5 px-4 items-center gap-2">
            ...
            <div className="p-4 md:p-6 lg:p-8 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <InputGroup
                  ...
                  onChange={(e) => {
                    setVehicleForm((prev) => ({ ...prev, vehicleBrand: e.target.value }));
                    setSavedVehicle(false);
                    setErrorVehicle("");
                  }}
                ...
                <InputGroup
                  ...
                  onChange={(e) => {
                    setVehicleForm((prev) => ({ ...prev, vehicleModel: e.target.value }));
                    setSavedVehicle(false);
                    setErrorVehicle("");
                  }}
                ...
                {/* Connector Type */}
                <div className="space-y-2">
                  <label className="text-[13px] font-black text-[#555] ml-1 uppercase tracking-tight">
                    Connector Type
                  </label>
                  <select
                    name="connectorType"
              ...
              {errorVehicle && (
                <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3 text-red-600">
                  <ErrorIcon />
                  <span className="text-sm font-bold">{errorVehicle}</span>
                </div>
              )}
              {savedVehicle && (
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3 text-green-700">
                  <CheckCircleIcon />
                  <span className="text-sm font-bold">Vehicle details saved successfully!</span>
                </div>
              )}
                ...
                className={`py-4 rounded-xl font-black text-[15px] uppercase tracking-wider transition-all shadow-lg flex items-center justify-center gap-3
                  ${
                    savingVehicle
                      ...
                      : "bg-[#EAB308] hover:bg-[#D97706] text-[#1A1A1A] active:scale-[0.98] shadow-[#EAB308]/30"
                  }`}
              >
                {savingVehicle ? (
