      ...
      <div className="flex-1 md:flex-none md:w-1/2 lg:w-[45%] flex flex-col items-center justify-center p-4 md:p-6 lg:p-12">
        ...
        <div className="w-full max-w-[400px] bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.1)] overflow-hidden border border-gray-100">
          ...
          <div className="p-4 md:p-6 lg:p-10 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6 font-medium">Access your EV portal</p>

            {error && (
              <div className="bg-red-50 text-red-600 p-3 rounded-xl text-xs mb-4 border border-red-100 font-bold animate-shake">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
              <div className="text-left">
                ...
                <input 
                  ...
                  className="w-full mt-1 p-3 rounded-xl border border-gray-100 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#16A34A] focus:border-transparent outline-none transition-all text-sm"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#16A34A] hover:bg-[#15803D] text-white font-bold rounded-xl transition-all shadow-lg shadow-green-100 disabled:opacity-70"
              >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[11px] text-[#9CA3AF] uppercase tracking-wider font-bold italic">or continue with</span>
              <div className="flex-1 h-px bg-gray-100" />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full relative py-3.5 bg-white hover:bg-gray-50 text-[#1A1A1A] font-bold rounded-xl transition-all duration-300 border border-gray-200 flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed group"
            >
              <GoogleIcon />
