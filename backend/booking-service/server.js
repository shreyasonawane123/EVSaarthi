...
// ── Auto-complete Logic ──────────────────────────────────────────
const { startSlotReleaseWorker } = require("./utils/slotReleaseWorker");

// Start worker with a shorter interval for development (30 seconds)
startSlotReleaseWorker(30000);
